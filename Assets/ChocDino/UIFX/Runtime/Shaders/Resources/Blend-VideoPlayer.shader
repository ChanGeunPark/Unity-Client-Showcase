Shader "Hidden/ChocDino/UIFX/Blend-VideoPlayer"
{
	Properties
	{
	...
	v2f vertVideoPlayer(appdata v)
	{
		...
		o.uv = TRANSFORM_TEX(v.uv, _MainTex) + unity_StereoEyeIndex * _RightEyeUVOffset.xy;
		o.color = v.color;
	...
	{
		float4 color = tex2D(_MainTex, i.uv) * _AlphaParam;
