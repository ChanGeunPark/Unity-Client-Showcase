...
namespace ChocDino.UIFX
{
	...
	public partial class BlurFilter : FilterBase
	{
		...
		[Tooltip("The power value for the tent blur kernel weights. 0.0 will give the same results as a box filter, 1.0 will give linear falloff, above 1.0 will give exponential falloff.")]
		[Range(0f, 4f)]
		[SerializeField] float _tentFalloff = 1.5f;
		...
		/// <summary>The power value for the tent blur kernel weights. 0.0 will give the same results as a box filter, 1.0 will give linear falloff, above 1.0 will give exponential falloff.</summary>
		public float TentFalloff { get { return _tentFalloff; } set { ChangeProperty(ref _tentFalloff, value); } }
		...
		private TentBlurReference _tentBlur = null;
		...
		private void UpdateAlgorithm()
		{
			...
			switch (_algorithm)
			{
				...
				case BlurAlgorithm.MultiBox:
					...
					break;
				case BlurAlgorithm.Tent:
					requiresChange = (_tentBlur == null);
					break;
			...
			switch (_algorithm)
			{
				...
				case BlurAlgorithm.Box:
					...
					break;
				case BlurAlgorithm.Tent:
					_tentBlur.Falloff = _tentFalloff;
					break;
				case BlurAlgorithm.MultiBox:
		...
		private void ChangeAlgorithm()
		{
			...
			switch (_algorithm)
			{
				...
				case BlurAlgorithm.Tent:
				{
					_currentBlur = _tentBlur = new TentBlurReference();
					break;
				}
				case BlurAlgorithm.Gaussian:
				{
