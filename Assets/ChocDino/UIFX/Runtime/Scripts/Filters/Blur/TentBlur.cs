...
{
	public class TentBlurReference : ITextureBlur
	{
		internal class BlurShader
		{
			internal const string Id = "Hidden/ChocDino/UIFX/TentBlur-Reference";

			internal static class Prop
			{
				internal static readonly int KernelRadius = Shader.PropertyToID("_KernelRadius");
				internal static readonly int WeightsPower = Shader.PropertyToID("_WeightsPower");
			}
		...
		void UpdateMaterial()
		{
			...
			_material.SetFloat(BlurShader.Prop.WeightsPower, _falloff);
