...
Shader "MyStudio/ParticleSimple"
{
	Properties
	{
		...
		LOD 0
			...
			Pass {				
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 tex2DNode2_g168 = tex2D( _CutoutFadeTexture, ( ( ( i.texcoord.xy - float2( 0.5,0.5 ) ) / max( lerpResult7_g168 , 0.0001 ) ) + float2( 0.5,0.5 ) ) );
					float4 appendResult16_g168 = (float4(appendResult15_g168 , ( temp_output_1_0_g168.a * ( 1.0 - ( tex2DNode2_g168.r * tex2DNode2_g168.a ) ) )));
					...
					float clampResult37_g169 = clamp( ( ( ( i.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g169.r + ( tex2D( _NoiseTexture, ( temp_output_57_0_g169 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
					float4 appendResult13_g169 = (float4(( float4( (i.color).rgb , 0.0 ) * temp_output_1_0_g169 ).rgb , ( temp_output_1_0_g169.a * pow( clampResult37_g169 , ( _CustomFadeSmoothness / max( tex2DNode3_g169.r , 0.05 ) ) ) * _CustomFadeAlpha )));
					...
					float clampResult25_g171 = clamp( ( ( ( ( temp_output_3_0_g171 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
					float3 lerpResult6_g171 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g171);
					float temp_output_9_0_g173 = max( _SplitToningContrast , 0.0 );
					float saferPower7_g173 = abs( ( temp_output_3_0_g171 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g173 ) , 0.0 ) ) ) );
					float3 lerpResult11_g171 = lerp( (temp_output_1_0_g171).rgb , ( lerpResult6_g171 * pow( saferPower7_g173 , temp_output_9_0_g173 ) ) , _SplitToningFade);
					...
					float3 lerpResult7_g174 = lerp( temp_output_4_0_g174 , ( temp_output_4_0_g174 + (_BlackTintColor).rgb ) , pow( ( 1.0 - min( max( max( break12_g174.r , break12_g174.g ) , break12_g174.b ) , 1.0 ) ) , max( _BlackTintPower , 0.001 ) ));
					...
					float3 lerpResult4_g175 = lerp( (temp_output_1_0_g175).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g175 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g175.a ) ));
					...
					float3 hsvTorgb24_g176 = HSVToRGB( float3(( hsvTorgb16_g176.x + _AdjustColorHueShift ),clampResult18_g176,( pow( saferPower7_g177 , temp_output_9_0_g177 ) * _AdjustColorBrightness )) );
...
/*ASEBEGIN
Version=18935
0;0;1920;1011;4744.398;2402.059;4.526339;True;True
...
Node;AmplifyShaderEditor.FunctionNode;78;-1156.72,-293.451;Inherit;False;TintVertex;-1;;167;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;103;-1094.157,-687.4542;Inherit;True;TextureFade;49;;168;b6b9d854da148684082ce91c9e92c063;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;97;-756.3032,-725.9235;Inherit;False;Property;_EnableCutoutSprite;Enable Cutout Sprite;48;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;90;-1154.998,126.8534;Inherit;False;_CustomFade;9;;169;09a17a2b3ff778e4baeae7d542f88dd6;0;3;57;FLOAT2;0,0;False;56;SAMPLER2D;;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;94;-101.8765,-215.0642;Inherit;False;_SplitToning;17;;171;6b87c8196f94bcd478491aaa714b31ef;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;81;746.9941,-187.6142;Inherit;False;_BlackTint;25;;174;e72823b8923579647a619869b654ace9;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;85;1573.545,-214.9836;Inherit;False;_AlphaTint;30;;175;ae9f8d24855c66643be02b2aa90f050e;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;86;1907.981,-348.1771;Inherit;False;Property;_EnableAlphaTint;Enable Alpha Tint;29;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;82;2407.541,-244.2802;Inherit;False;_AdjustColor;2;;176;e7083192d13fe334cab64b3d59374f2b;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1EC28CF6B5C13DCC027FC259C7F89F89C19AF525